...
function About ({setplayState}) {
    ...
    <div className ='about'>
        ...
        <div  className = "about-right">
            ...
            <p>Embrak on a transformative educational journey with our 
            university's compreshensive education programs. Our cutting-edge
            curriculm is designed to empower students with the knowledge,
